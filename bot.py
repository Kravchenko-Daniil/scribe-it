...
WELCOME = (
    ...
    "<b>На выходе</b> — <code>.txt</code> с готовым текстом, имя файла = название видео. "
    "Рядом лягут <code>.srt</code> с таймкодами и сырой <code>.json</code> — на случай, если строить что-то поверх.\n\n"
